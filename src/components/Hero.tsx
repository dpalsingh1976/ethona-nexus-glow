    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-24">
        ...
        <div className="relative">
          ...
          <div
            aria-hidden
            className="absolute -bottom-8 left-1/2 z-0 h-48 w-[130%] -translate-x-1/2"
          >
            <div className="absolute inset-0 rounded-[50%] bg-cyan-400/15 blur-[80px] opacity-80 mix-blend-screen" />
            <div className="absolute inset-0 rounded-[50%] bg-cyan-500/50 blur-2xl mix-blend-screen [mask-image:radial-gradient(55%_100%_at_50%_100%,transparent_35%,black_42%,transparent_48%)]" />
          </div>
          ...
          <img
            ...
            className="relative z-10 w-full max-w-[900px] bg-transparent drop-shadow-[0_20px_50px_rgba(0,200,255,0.2)]"
          />
        </div>
      </div>
